...
# Kriging is a hybrid model incorporating usually Gaussian Process Regression
# and Polynomial regression, sometimes RBF. Slightly varying from a standard
# ensemble of the two.
# used in @https://www.kaggle.com/shtrausslearning/geospatial-data-visualisation-australia
# and @https://www.kaggle.com/shtrausslearning/sed-spectogram-broadband-model-peak-identifier
