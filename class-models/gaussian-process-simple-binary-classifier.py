''' Simple Gaussian Process Classifier based on Regression '''
# We can utilise the Gaussian Process Regressor as a binary
# classifier using this simplistic approach
